...
if selected == "Home":
    ...
    st.info('''
    - Click on the pointed top left arrow to navigate to the menu.
    - It will display a menu list consisting of **the home, rent evaluation, Compare places and about us**. Click on any of them to perform operations.
    - **NB :** Do not click on the top right menu bar, it is not very important. Just a bunch of redundant settings.

    ''')
    st.write('---')

    st.write('### About Profile')
